  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['/']) }}">
        <a href="/recruiter/jobs/all" class="nav-link">
          <i class="link-icon" data-feather="box"></i>
          <span class="link-title">All Jobs</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/']) }}">
        <a href="/recruiter/jobs/add" class="nav-link">
          <i class="link-icon" data-feather="box"></i>
      ...
      <li class="nav-item {{ active_class(['/']) }}">
        <a href="/recruiter/jobs/candidates" class="nav-link">
          <i class="link-icon" data-feather="box"></i>
          <span class="link-title">New Candidates</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/']) }}">
        <a href="{{ url('/freelancer/application/') }}" class="nav-link">
          <i class="link-icon" data-feather="box"></i>
          <span class="link-title">Old Applications</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['/']) }}">
